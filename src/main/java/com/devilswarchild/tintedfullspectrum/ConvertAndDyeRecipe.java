...
// Takes ANY vanilla planks/wood stairs/slab/fence/fence gate (any of the ~11 wood types) plus a
// Colored Dye, and outputs the equivalent Tinted Planks shape in that dye's color -- one universal
// converter rather than needing a separate blank-dye step to obtain the mod's own plain Tinted
// Planks shape first. Which vanilla item is "convertible" is determined by vanilla's own planks/
// wooden_stairs/wooden_slabs/wooden_fences/fence_gates tags; which Tinted Planks shape it maps to
// is determined by the input block's Java type (StairBlock/SlabBlock/FenceBlock/FenceGateBlock, or
// plain Block for planks themselves), not the tag, since the tags don't distinguish shape on their
// own.
